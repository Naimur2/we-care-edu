    ...
    >
      <Stack component={"div"} className="container">
        ...
        >
          ...
          >
            WeCare Education offers a comprehensive range of programs, from
            admissions support to visa assistance, to ensure a smooth and
            stress-free application process for our students.
          </CTypography>
          <Box
            sx={{
              ":after": {
        ...
        <Box sx={{display: "flex", justifyContent: "center", padding: "12px 0 0 0"}}>
          <Stack pt={2}>
            <CButton
              onClick={handleSeeMoreOrLess}
              btnTitle={
                programs?.length !== dataCount ? "See More" : "See Less"
              }
              fontSize={{
                md: 20,
                xs: 16,
